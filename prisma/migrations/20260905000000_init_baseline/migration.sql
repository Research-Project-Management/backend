...
CREATE TABLE "papers" (
    ...
    "extra" TEXT DEFAULT '',
    "rag_doc_id" TEXT,
    "rag_indexed_at" TIMESTAMPTZ(6),
    "rag_last_attempt_at" TIMESTAMPTZ(6),
...
-- CreateTable
CREATE TABLE "catalog_merge_lineage" (
    "id" UUID NOT NULL,
    "workspace_id" UUID NOT NULL,
...
CREATE TABLE "paper_attachments" (
    ...
    "extraction_started_at" TIMESTAMPTZ(6),
    "extraction_completed_at" TIMESTAMPTZ(6),
...
-- CreateIndex
CREATE INDEX "catalog_merge_lineage_workspace_id_source_item_id_idx" ON "catalog_merge_lineage"("workspace_id", "source_item_id");

-- CreateIndex
CREATE INDEX "catalog_merge_lineage_target_item_id_idx" ON "catalog_merge_lineage"("target_item_id");
...
-- CreateIndex
CREATE INDEX "ingestion_runs_idempotency_key_workspace_id_idx" ON "ingestion_runs"("idempotency_key", "workspace_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "ingestion_runs_workspace_id_idempotency_key_key" ON "ingestion_runs"("workspace_id", "idempotency_key");
...
-- AddForeignKey
ALTER TABLE "catalog_merge_lineage" ADD CONSTRAINT "catalog_merge_lineage_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "catalog_merge_lineage" ADD CONSTRAINT "catalog_merge_lineage_target_item_id_fkey" FOREIGN KEY ("target_item_id") REFERENCES "papers"("id") ON DELETE CASCADE ON UPDATE CASCADE;
