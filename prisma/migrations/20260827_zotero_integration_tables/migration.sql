...
-- CreateTable
CREATE TABLE IF NOT EXISTS "zotero_bindings" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "zotero_item_bindings" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "zotero_sync_failures" (
    "id" TEXT NOT NULL,
    "sync_run_id" TEXT,
    "binding_id" TEXT NOT NULL,
    "workspace_id" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "zotero_connections_workspace_id_status_idx" ON "zotero_connections"("workspace_id", "status");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "zotero_connections_workspace_id_zotero_user_id_key" ON "zotero_connections"("workspace_id", "zotero_user_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "zotero_bindings_connection_id_idx" ON "zotero_bindings"("connection_id");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "zotero_bindings_workspace_id_remote_library_type_remote_lib_key" ON "zotero_bindings"("workspace_id", "remote_library_type", "remote_library_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "zotero_item_bindings_workspace_id_entity_type_entity_id_idx" ON "zotero_item_bindings"("workspace_id", "entity_type", "entity_id");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "zotero_item_bindings_binding_id_remote_key_key" ON "zotero_item_bindings"("binding_id", "remote_key");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "zotero_item_bindings_binding_id_entity_type_entity_id_key" ON "zotero_item_bindings"("binding_id", "entity_type", "entity_id");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "zotero_sync_runs_binding_id_started_at_idx" ON "zotero_sync_runs"("binding_id", "started_at");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "zotero_sync_failures_binding_id_status_idx" ON "zotero_sync_failures"("binding_id", "status");

-- AddForeignKey
ALTER TABLE "zotero_connections" DROP CONSTRAINT IF EXISTS "zotero_connections_workspace_id_fkey";
...
-- AddForeignKey
ALTER TABLE "zotero_connections" DROP CONSTRAINT IF EXISTS "zotero_connections_user_id_fkey";
...
-- AddForeignKey
ALTER TABLE "zotero_bindings" DROP CONSTRAINT IF EXISTS "zotero_bindings_connection_id_fkey";
...
-- AddForeignKey
ALTER TABLE "zotero_bindings" DROP CONSTRAINT IF EXISTS "zotero_bindings_workspace_id_fkey";
...
-- AddForeignKey
ALTER TABLE "zotero_item_bindings" DROP CONSTRAINT IF EXISTS "zotero_item_bindings_binding_id_fkey";
...
-- AddForeignKey
ALTER TABLE "zotero_item_bindings" DROP CONSTRAINT IF EXISTS "zotero_item_bindings_workspace_id_fkey";
...
-- AddForeignKey
ALTER TABLE "zotero_sync_runs" DROP CONSTRAINT IF EXISTS "zotero_sync_runs_binding_id_fkey";
...
-- AddForeignKey
ALTER TABLE "zotero_sync_runs" DROP CONSTRAINT IF EXISTS "zotero_sync_runs_workspace_id_fkey";
...
-- AddForeignKey
ALTER TABLE "zotero_sync_failures" DROP CONSTRAINT IF EXISTS "zotero_sync_failures_sync_run_id_fkey";
...
-- AddForeignKey
ALTER TABLE "zotero_sync_failures" DROP CONSTRAINT IF EXISTS "zotero_sync_failures_binding_id_fkey";
...
-- AddForeignKey
ALTER TABLE "zotero_sync_failures" DROP CONSTRAINT IF EXISTS "zotero_sync_failures_workspace_id_fkey";
