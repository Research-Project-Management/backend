...
libraryRouter.put(
  ...
  asyncHandler(async (req, res) => {
    ...
    const fields = [
      ...
      "keywords", "itemType", "editors", "journal", "publicationTitle",
      "publicationDate", "publisher", "place", "tags", "volume", "issue",
      "section", "partNumber", "partTitle", "pages", "series", "seriesTitle",
      "seriesText", "issn", "isbn", "pmid", "pmcid", "url", "type",
      "language", "journalAbbr", "shortTitle", "rights", "license",
      "citationKey", "libraryCatalog", "archive", "archiveLocation",
      "callNumber", "accessedAt", "extra", "notes",
    ];
