...
export const workspaceStickyController = container.resolve("workspaceStickyController");
export const projectStickyController = container.resolve("projectStickyController");
