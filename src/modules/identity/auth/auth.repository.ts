...
import { IRefreshTokenRepository } from './types/auth.type';
import * as crypto from 'crypto';

@Injectable()
export class AuthRepository implements IRefreshTokenRepository {
  ...
  async findUserByEmail(
    ...
    (User & { profile?: { name: string; avatar: string | null } | null }) | null
  > {
...
export const AuthnRepository = AuthRepository;
export type AuthnRepository = AuthRepository;
