...
import { AuthProvider, Prisma, ThemePreference, User } from '@prisma/client';
import {
  IUserRepository,
  OwnedProjectInfo,
...
export class UserRepository implements IUserRepository {
  ...
  async unlinkAccount(userId: string, provider: AuthProvider): Promise<void> {
