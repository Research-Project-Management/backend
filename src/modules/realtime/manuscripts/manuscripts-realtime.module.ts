/**
 * realtime/manuscripts/manuscripts-realtime.module.ts
 * Submodule packaging all Real-Time Collaboration components for Manuscripts (Hexagonal Architecture).
 */
...
export class ManuscriptsRealtimeModule {}
