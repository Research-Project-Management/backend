...
export class SuggestionController {
  ...
  @ApiOperation({
    summary: 'List review suggestions (Track Changes) for a document page',
  })
  ...
  @ApiOperation({
    summary: 'Create a new proposed edit/suggestion in Track Changes mode',
  })
  ...
  @ApiOperation({
    summary: 'Accept a proposed edit and apply diff to document',
  })
