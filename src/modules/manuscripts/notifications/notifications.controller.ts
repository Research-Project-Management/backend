...
@ApiTags('Manuscripts - Notifications')
@Controller(['manuscripts/notifications', 'notifications'])
 ...
 * - DELETE /key/:key
 */
@ApiTags('Manuscripts - Overleaf Parity Notifications')
@Controller(['manuscripts/v1/notifications-compat', 'v1/notifications-compat'])
