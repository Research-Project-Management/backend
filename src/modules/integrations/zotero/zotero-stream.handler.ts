...
import { IntegrationOutboxEvent } from '../../library/library-sync.port';
...
@Injectable()
export class ZoteroStreamOutboxHandler {
  ...
  async handle(event: IntegrationOutboxEvent): Promise<void> {
