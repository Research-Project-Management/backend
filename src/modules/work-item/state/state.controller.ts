...
export class StateController {
  ...
  @ApiOperation({
    summary:
      'Create a new work item state with group categorization (Admin only)',
  })
  ...
  @ApiOperation({
    summary:
      'Reorder states sequence and optionally update groups (Admin only)',
  })
  ...
  @ProjectRoles('owner')
  @ApiOperation({
    summary: 'Update state name, color, group, or default flag (Admin only)',
  })
  ...
  @ProjectRoles('owner')
  @ApiOperation({
    summary: 'Delete a state with safe WorkItem migration rules',
  })
  @ApiQuery({
    name: 'targetStateId',
    required: false,
  ...
  async deleteState(
    ...
    const fallbackId = targetStateId || targetColumnId || fallbackStateId;
