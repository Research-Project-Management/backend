...
export class UpdatePropertyDto {
  ...
  @ApiPropertyOptional({
    description:
      'Display options such as layout, group_by, order_by (camelCase)',
  ...
  @ApiPropertyOptional({
    description:
      'Display options such as layout, group_by, order_by (snake_case)',
    example: { layout: 'kanban', group_by: 'state', order_by: '-created_at' },
  })
  @IsOptional()
  @IsObject()
  ...
  @ApiPropertyOptional({
    description:
      'Toggle which property badges/columns show up on cards (camelCase)',
  ...
  @ApiPropertyOptional({
    description:
      'Toggle which property badges/columns show up on cards (snake_case)',
    example: { assignee: true, priority: true, due_date: true, labels: true },
  })
  @IsOptional()
  @IsObject()
