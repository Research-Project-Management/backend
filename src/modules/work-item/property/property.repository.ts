...
export class PropertyRepository {
  ...
  private mapRecord(record: any): ProjectUserPropertyData & {
    ...
    const displayFilters =
      (record.displayFilters as Record<string, any>) || DEFAULT_DISPLAY_FILTERS;
    const displayProperties =
      (record.displayProperties as Record<string, any>) ||
      DEFAULT_DISPLAY_PROPERTIES;
    ...
    const preferences =
      (record.preferences as Record<string, any>) || DEFAULT_PREFERENCES;
