...
export class PropertyService {
  ...
  async updateUserProperties(
    ...
    const displayFilters =
      updatePropertyDto.display_filters ?? updatePropertyDto.displayFilters;
    const displayProperties =
      updatePropertyDto.display_properties ??
      updatePropertyDto.displayProperties;
    const richFilters =
      updatePropertyDto.rich_filters ?? updatePropertyDto.richFilters;
    const sortOrder =
      updatePropertyDto.sort_order ?? updatePropertyDto.sortOrder;

    const updated = await this.propertyRepository.update(projectId, userId, {
      ...(updatePropertyDto.filters !== undefined && {
        filters: updatePropertyDto.filters,
      }),
      ...(displayFilters !== undefined && { displayFilters }),
      ...(displayProperties !== undefined && { displayProperties }),
      ...(richFilters !== undefined && { richFilters }),
      ...(updatePropertyDto.preferences !== undefined && {
        preferences: updatePropertyDto.preferences,
      }),
