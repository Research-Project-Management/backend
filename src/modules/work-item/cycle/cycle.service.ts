...
import { calculateCycleStats, CycleStats } from './utils/cycle.util';
...
export class CycleService {
  ...
  private calculateStats(
    ...
    return calculateCycleStats(tasks);
  }
  ...
  async completeCycle(cycleId: string, dto: CompleteCycleDto) {
    ...
    await Promise.all([
      ...
      ...(dto.targetCycleId
        ...
        : []),
      this.cache?.del(WORK_ITEM_REDIS_KEYS.projectTasks(cycle.projectId)),
