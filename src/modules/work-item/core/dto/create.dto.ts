...
export class CreateWorkItemDto {
  ...
  @IsString()
  @IsNotEmpty({ message: 'WorkItem title is required' })
  title!: string;
  ...
  @ApiPropertyOptional({
    description: 'Additional co-assignee user IDs',
    type: [String],
  })
  @IsArray()
  @IsString({ each: true })
...
export const CreateDto = CreateWorkItemDto;
export type CreateDto = CreateWorkItemDto;
