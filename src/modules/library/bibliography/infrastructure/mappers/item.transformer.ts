...
import { ItemFieldDefinition } from '../../domain/types/types.types';
import { IItemTransformerPort } from '../../domain/ports/item-transformer.port';
 ...
 */
@Injectable()
export class ItemTransformer implements IItemTransformerPort {
