...
import type { TransactionHelpers } from '../../../shared-kernel/outbox/transaction.service';
import type {
...
import {
  ...
  CollectionTreeNode,
} from '../../domain/types/collections.types';
import {
  buildCollectionTree,
  normalizeParentId,
...
export class CollectionsService {
  ...
  async detachItemFromCollection(
    ...
    const itemExists = await this.repo.verifyItemInScope(itemId, scopeWhere);
    if (!itemExists) {
