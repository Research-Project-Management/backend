...
import {
  FULLTEXT_QUERY_PORT,
  IFulltextQueryPort,
} from '../../domain/ports/fulltext-query.port';
 ...
 *
 * Application layer: depends strictly on IFulltextQueryPort (Domain port).
 * Does NOT import QueryRepository, Prisma or NestJS HTTP concerns.
 */
@Injectable()
export class GetFulltextUseCase {
  constructor(
    @Inject(FULLTEXT_QUERY_PORT)
    private readonly queryRepo: IFulltextQueryPort,
  ) {}
