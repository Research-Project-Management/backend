...
export class ConversionService {
  ...
  constructor(
    private readonly registryService: TypesService,
...
export const ItemTypeConversionService = ConversionService;
export type ItemTypeConversionService = ConversionService;
