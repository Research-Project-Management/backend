...
import { VersionMismatchException } from './items.errors';
...
import { CatalogItemSummary } from './items.types';
import { getFileContentPath } from '../../storage/storage.port';
import { SCHEMA_V42_DATA } from '../types/types.data';
...
const CATALOG_COLUMN_METADATA_FIELDS = new Set([
  'title',
  'doi',
  'publicationTitle',
  'publisher',
...
const LEGACY_TYPE_SPECIFIC_EXTRA_FIELDS = [
  'seriesNumber',
  'abstractNote',
  'edition',
  'numPages',
...
const TYPE_SPECIFIC_EXTRA_FIELDS = [
  ...new Set([
...
function parseAccessDate(value?: string): Date | undefined {
