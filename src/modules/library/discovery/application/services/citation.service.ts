...
import {
  ...
  ReferenceData,
} from '../../domain/types/citation.types';
import { DoiContentNegotiationService } from './doi-content-negotiation.service';
import { CslEngineService } from './csl-engine.service';
import { CslJsonMapper } from '../mappers/csl-json.mapper';
import {
  METADATA_PORT,
  MetadataPort,
  ItemMetadata,
} from '../../../processing/domain/types/metadata.types';
import {
  CATALOG_FACADE,
  ICatalogFacade,
} from '../../../catalog/catalog.facade';
import { normalizeTags } from '../../../catalog/application/utils/tags.utils';
import {
...
export class CitationService {
  ...
  async formatItemById(
    ...
    const item: any = this.catalogFacade
      ? await this.catalogFacade.getItem(userId, itemId, projectId)
