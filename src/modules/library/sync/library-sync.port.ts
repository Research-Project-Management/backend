...
export const LIBRARY_PORT = LIBRARY_SYNC_PORT;
...
export interface LibrarySyncPort {
  getItemSnapshot(
...
export type ILibrarySyncPort = LibrarySyncPort;
export type LibraryPort = LibrarySyncPort;
