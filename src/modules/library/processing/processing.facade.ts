...
export const PROCESSING_FACADE = 'PROCESSING_FACADE';

export interface IProcessingFacade {
...
/**
 * Public Facade for Processing Bounded Context (Supporting Domain).
 * Shields ingestion pipelines, curation/dedup algorithms, and retraction checks.
 */
@Injectable()
export class ProcessingFacade implements IProcessingFacade {
  constructor(
