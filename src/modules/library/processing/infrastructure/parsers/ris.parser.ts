...
import { ItemMetadata, CreatorInput } from '../../domain/types/metadata.types';
import { IngestionValidationException } from '../../domain/errors/ingestion.errors';
import { cleanAbstractText } from '../../../catalog/application/utils/items.utils';
import { normalizeAcademicTags } from '../../../catalog/application/utils/tags.utils';
import {
  ZoteroTranslatorClient,
  ZoteroItem,
} from '../../../shared-kernel/infra/zotero/zotero-translator.client';
