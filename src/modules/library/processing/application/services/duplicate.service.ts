...
import { TagsService } from '../../../catalog/application/services/tags.service';
import { CollectionsService } from '../../../catalog/application/services/collections.service';
import { AttachmentsService } from '../../../content/application/services/attachments.service';
import { NotesService } from '../../../content/application/services/notes.service';
import { StateService } from '../../../catalog/application/services/state.service';
import {
  ITEM_READ_PORT,
  IItemReadPort,
...
import { ItemsMapper } from '../../../catalog/infrastructure/mappers/items.mapper';
...
export class DuplicateService {
  ...
  async autoResolveCluster(
    ...
    const candidateItems = await this.itemReadPort.findByIds(
      userId,
      clusterItemIds,
      projectId,
    );
    ...
    for (const field of ALLOWED_MERGE_METADATA_FIELDS) {
      ...
      if (
        ...
        if (donor) {
          fieldSelections[field] = (donor as any)[field];
        }
      }
    }
