...
} from './item-type-registry.types';
import {
  SCHEMA_V42_DATA,
  LIBRARY_SCHEMA_VERSION,
  SCHEMA_SOURCE,
  ALL_CREATOR_ROLES,
} from './item-type-definitions.data';

@Injectable()
export class ItemTypeRegistryService {
  private readonly logger = new Logger(ItemTypeRegistryService.name);
