...
export class DiscoveryRepository {
  ...
  private readonly memSavedSearches = new Map<string, SavedSearch[]>();
  ...
  async createSavedSearch(
    ...
    try {
      ...
      const list = this.memSavedSearches.get(workspaceId) ?? [];
      list.push(record);
      this.memSavedSearches.set(workspaceId, list);
      return record;
    }
  }
  ...
  async deleteSavedSearch(
    ...
    try {
      ...
      this.memSavedSearches.set(workspaceId, filtered);
