...
import { ZoteroPullWorker } from '../../../../src/modules/library/integrations/zotero/zotero-pull.worker';
import { ZoteroReconcileWorker } from '../../../../src/modules/library/integrations/zotero/zotero-reconcile.worker';
...
describe('Zotero Connector, Mapper & Sync Invariants (Integration)', () => {
  ...
  beforeAll(async () => {
    ...
    const changeLogRepo = harness.moduleRef.get(ChangeLogRepository);
