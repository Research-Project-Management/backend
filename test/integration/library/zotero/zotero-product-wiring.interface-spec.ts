...
import { ZoteroFileConnector } from '../../../../src/modules/library/integrations/zotero/zotero-file.connector';
...
describe('Zotero Product Wiring & Release Verification (Steps 1-12)', () => {
  ...
  beforeAll(async () => {
    ...
    harness.featureFlags.setWorkspaceOverride(workspaceId, {
      zoteroTwoWaySync: true,
    });

    syncPolicy = new ZoteroSyncPolicy(harness.featureFlags, harness.prisma);
