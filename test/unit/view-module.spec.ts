...
describe('Saved Views (Issue Views) Module', () => {
  ...
  beforeEach(() => {
    ...
    service = new ViewService(
      ...
      mockWorkItemService as any,
    );
  });

  describe('getViews', () => {
    it('should return all visible project views for the user', async () => {
      mockRepo.findProjectViews.mockResolvedValue([
        mockPublicView,
        mockPrivateView,
      ]);
  ...
  describe('getView', () => {
    ...
    it('should return a private view to a project owner', async () => {
      mockRepo.findById.mockResolvedValue(mockPrivateView);
  ...
  describe('updateView', () => {
    ...
    it('should allow owner to update locked view', async () => {
      mockRepo.findById.mockResolvedValue(mockLockedView);
      mockRepo.update.mockResolvedValue({
        ...mockLockedView,
        name: 'Admin Updated',
  ...
  describe('deleteView', () => {
    it('should allow author to delete view', async () => {
      ...
      const res = await service.deleteView(
        projectId,
        viewId,
        userId,
        'contributor',
    ...
    it('should allow owner to delete view created by another user', async () => {
      mockRepo.findById.mockResolvedValue(mockPublicView);
      mockRepo.delete.mockResolvedValue(true);
  ...
  describe('toggleFavorite, favorite & unfavorite', () => {
    it('should toggle favorite status for the user', async () => {
      ...
      const res = await service.toggleFavorite(
        projectId,
        viewId,
        userId,
        'contributor',
    ...
    it('should explicitly favorite a view (Plane.so parity)', async () => {
      ...
      const res = await service.favorite(
        projectId,
        viewId,
        userId,
        'contributor',
    ...
    it('should explicitly unfavorite a view (Plane.so parity)', async () => {
      ...
      const res = await service.unfavorite(
        projectId,
        viewId,
        userId,
        'contributor',
  ...
  describe('Plane.so aliases compatibility', () => {
    ...
    it('should support getFavoriteViews', async () => {
      mockRepo.findUserFavoriteViews = jest
        .fn()
        .mockResolvedValue([
      ...
      expect(mockRepo.findUserFavoriteViews).toHaveBeenCalledWith(
        projectId,
        userId,
      );
    });
  ...
  describe('getViewWorkItems', () => {
    ...
    it('should allow runtime extraQuery parameters to merge with view filters', async () => {
      ...
      await service.getViewWorkItems(projectId, viewId, userId, 'viewer', {
        search: 'Login issue',
      });
