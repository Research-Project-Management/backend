...
import { TreeService } from '@/modules/document/tree/tree.service';
import { TreeRepository } from '@/modules/document/tree/tree.repository';
...
describe('Document TreeService (Tree Hierarchy Operations)', () => {
  let service: TreeService;
  let repo: jest.Mocked<TreeRepository>;
