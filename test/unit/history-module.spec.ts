...
describe('History Module', () => {
  ...
  describe('getTransitions', () => {
    it('should throw NotFoundException if WorkItem not found', async () => {
      ...
      await expect(service.getTransitions(taskId)).rejects.toThrow(
        NotFoundException,
      );
    });
  ...
  describe('getUnifiedFeed', () => {
    it('should return comments tab feed', async () => {
      ...
      const result = await service.getUnifiedFeed(taskId, {
        tab: CollaborationTab.COMMENTS,
      });
