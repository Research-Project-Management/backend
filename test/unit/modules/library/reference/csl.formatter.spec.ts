...
describe('CslFormatter', () => {
  ...
  it('should format in APA 7th Edition style', () => {
    ...
    expect(res.bibliography).toContain('Vaswani, A., Shazeer, N., & Parmar, N. (2017). Attention Is All You Need.');
    expect(res.bibliography).toContain('Advances in Neural Information Processing Systems, 30, 5998-6008.');
    expect(res.bibliographyHtml).toContain('<i>Advances in Neural Information Processing Systems</i>');
  });
  ...
  it('should format in IEEE style', () => {
    ...
    expect(res.bibliography).toContain('[1] A. Vaswani, N. Shazeer, and N. Parmar, "Attention Is All You Need,"');
  ...
  it('should format in Nature style', () => {
    ...
    expect(res.inText).toBe('Vaswani et al. (2017)');
    expect(res.bibliography).toContain('Vaswani, A., Shazeer, N., Parmar, N. Attention Is All You Need. Advances in Neural Information Processing Systems 30, 5998-6008 (2017).');
  });
  ...
  it('should format in Harvard style', () => {
    ...
    expect(res.inText).toBe('(Vaswani et al., 2017)');
    expect(res.bibliography).toContain('Vaswani, A., Shazeer, N. and Parmar, N., 2017. Attention Is All You Need.');
  });
  ...
  it('should format in Chicago style', () => {
    ...
    expect(res.inText).toBe('(Vaswani et al. 2017)');
    expect(res.bibliography).toContain('Vaswani, Ashish, Noam Shazeer, and Niki Parmar. 2017. "Attention Is All You Need."');
  });
  ...
  it('should format in MLA 9th style', () => {
    ...
    expect(res.bibliography).toContain('Vaswani, Ashish, et al. "Attention Is All You Need."');
  });
  ...
  it('should format in Vancouver style', () => {
    ...
    expect(res.inText).toBe('(1)');
    expect(res.bibliography).toContain('1. Vaswani A, Shazeer N, Parmar N. Attention Is All You Need.');
  });
});
