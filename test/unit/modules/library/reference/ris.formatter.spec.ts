...
`;
    ...
    expect(entries[0].journal).toBe('Advances in Neural Information Processing Systems');
  ...
  it('should format paper into standard RIS entry string', () => {
    ...
    expect(risOutput).toContain('TI  - Deep Residual Learning for Image Recognition');
