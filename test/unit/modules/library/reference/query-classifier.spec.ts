import { QueryClassifierUtil } from '@/modules/library/reference/utils/query-classifier.util';
...
describe('QueryClassifierUtil', () => {
  it('should correctly classify raw DOI strings', () => {
    ...
    const res2 = QueryClassifierUtil.classify('https://doi.org/10.1038/s41586-020-2649-2');
  ...
  it('should correctly classify arXiv identifiers and URLs', () => {
    ...
    const res3 = QueryClassifierUtil.classify('https://arxiv.org/abs/1706.03762');
    expect(res3.type).toBe('ARXIV');
    expect(res3.clean).toBe('1706.03762');

    const res4 = QueryClassifierUtil.classify('https://arxiv.org/pdf/1706.03762.pdf');
