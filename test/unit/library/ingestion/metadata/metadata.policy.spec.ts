...
describe('MetadataRoutingPolicy', () => {
  ...
  describe('validateUrl — SSRF prevention', () => {
    ...
    it('blocks 172.31.x.x private', () => expectBlocked('http://172.31.255.255/'));
    it('blocks 192.168.x.x private', () => expectBlocked('http://192.168.1.1/'));
    it('blocks link-local 169.254.x.x', () => expectBlocked('http://169.254.0.1/'));
    it('blocks AWS metadata IP', () => expectBlocked('http://169.254.169.254/'));
    it('blocks Alibaba Cloud metadata', () => expectBlocked('http://100.100.100.200/'));
    ...
    it('allows public https URL', () => expectAllowed('https://www.nature.com/articles/foo'));
    it('allows public http URL', () => expectAllowed('http://api.example.com/foo'));
