...
describe('metadata.identifiers re-exports', () => {
  describe('normalizeDoi', () => {
    ...
    it('strips https://dx.doi.org/', () =>
      expect(normalizeDoi('https://dx.doi.org/10.1234/foo')).toBe(
        '10.1234/foo',
      ));
    it('lowercases', () =>
  ...
  describe('normalizeArxivId', () => {
    ...
    it('strips version with stripVersion option', () =>
      expect(normalizeArxivId('1706.03762v5', { stripVersion: true })).toBe(
        '1706.03762',
      ));
    it('returns undefined for garbage', () =>
  ...
  describe('normalizePmid', () => {
    it('strips pmid: prefix', () =>
      expect(normalizePmid('pmid:12345')).toBe('12345'));
    it('strips pubmed URL', () =>
      expect(normalizePmid('https://pubmed.ncbi.nlm.nih.gov/12345678/')).toBe(
        '12345678',
      ));
  ...
  describe('normalizePmcid', () => {
    it('normalizes PMC12345', () =>
      expect(normalizePmcid('PMC12345')).toBe('PMC12345'));
    it('normalizes PMCID:12345', () =>
      expect(normalizePmcid('PMCID:12345')).toBe('PMC12345'));
    it('returns undefined for garbage', () =>
      expect(normalizePmcid('abc')).toBeUndefined());
  });
  ...
  describe('formatCanonicalId', () => {
    ...
    it('formats arxiv scheme', () =>
      expect(formatCanonicalId('arxiv', '1706.03762')).toBe(
        'arxiv:1706.03762',
      ));
